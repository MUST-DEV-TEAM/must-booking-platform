...
| [07](roadmap/milestones/07-auth-pages.md) | Auth Pages | Shared login/signup/forgot-password UI and the `apps/web` component-library foundation everything after it consumes. **New (ADR-0023).** |
