# Milestone 9: Clock PMS+ Adapter (Basic Integration)
...
8. Webhook endpoint skeleton (SNS-shaped, section 20): signature verification, dedup, fast-2xx-then-queue — event *hydration* can be minimal/manual-triggered for this milestone; full reconciliation is Milestone 10+.
...
## Explicitly not included (deferred to post-Milestone-10 hardening backlog)
