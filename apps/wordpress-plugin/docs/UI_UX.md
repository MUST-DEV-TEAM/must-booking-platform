...
- A property can supply default room rules, with an optional physical-room override that fully replaces it. The public catalog resolves the effective text; the room-details page displays it as a separate section only when supplied.
